...
def get_fb_raw_data(ad_account_id: str, 
    ...
    appsecret_proof = hmac.new(
        ...
        msg=meta_access_token.encode('utf-8'),
    ...
    try:
        ...
        if "publisher_platform" in breakdown_to_arr:
            print("Extracting data for breakdown:", breakdown_to_arr)
...
def get_next_day_data(ad_account_id: str, 
    ...
    while not extract_has_data:
        ...
        raw_data = get_fb_raw_data(ad_account_id, time_range, breakdown,meta_app_secret, meta_access_token)
