...
def transform_igposts_data(ig_posts_raw_data: list[dict], page_id:str) -> list[InstaPostModel]:
    ...
    for post in ig_posts_raw_data:
        transformed_insight = InstaPostModel(
            ...
            profile_activity=post.get('profile_activity', 0),
            total_interactions=post.get('total_interactions', 0),
            ig_reels_avg_watch_time=post.get('ig_reels_avg_watch_time', 0),
            ig_reels_video_view_total_time=post.get('ig_reels_video_view_total_time', 0),
