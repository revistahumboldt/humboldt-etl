...
def extract_ad_insights(ad_account_id: str, date_preset: str = 'yesterday') -> list:
    """
    Extrai insights de anúncios de uma conta de anúncios específica.
    Args:
        ad_account_id: O ID da conta de anúncios (ex: 'act_12345').
        date_preset: O período para extrair os insights (ex: 'yesterday', 'last_7_days').
    Returns:
        Uma lista de dicionários contendo os dados brutos dos insights.
    """
...
def extract_campaigns(ad_account_id: str) -> list:
    """Extrai dados de campanhas ativas."""
