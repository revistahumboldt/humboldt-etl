...
def run_etl(gcp_project_id: str,
    ...
    try:
        # 0. Get last date from BQ to set as since param
        print({'since': '2023-05-01', 'until': '2023-06-01'})

        # 1. Extracting
        print("\n2. Data extraction for ig posts...")
        raw_ig_posts_data = get_raw_igposts(page_id, {'since': '2023-05-01', 'until': '2023-06-01'})
