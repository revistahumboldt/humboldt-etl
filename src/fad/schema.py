...
platform_ad_insights_schema = [
    ...
    # can be null 
    SchemaField("publisher_platform", "STRING", mode="NULLABLE", description="Plataform"),
    SchemaField("platform_position", "STRING", mode="NULLABLE", description="Position"),
